 ...
 */
package apktool.brut.androlib.res;
...
import apktool.brut.androlib.meta.PackageInfo;
import apktool.brut.androlib.meta.VersionInfo;
import apktool.brut.androlib.res.data.*;
import apktool.brut.androlib.res.decoder.*;
import apktool.brut.androlib.res.decoder.ARSCDecoder.ARSCData;
import apktool.brut.androlib.res.decoder.ARSCDecoder.FlagsOffset;
import apktool.brut.androlib.res.util.ExtMXSerializer;
import apktool.brut.androlib.res.util.ExtXmlSerializer;
...
import apktool.brut.directory.*;
import apktool.brut.util.AaptManager;
import apktool.brut.util.Duo;
import apktool.brut.util.OS;
import apktool.brut.util.OSDetection;
...
final public class AndrolibResources {
    ...
    public ResPackage loadMainPkg(ResTable resTable, ExtFile apkFile)
        ...
        switch (pkgs.length) {
            case 1:
                ...
                break;
            case 2:
                if (pkgs[0].getName().equals("apktool/android")) {
                    LOGGER.warning("Skipping \"apktool.android\" package group");
                    pkg = pkgs[1];
                    break;
    ...
    public ResPackage selectPkgWithMostResSpecs(ResPackage[] pkgs) {
        ...
        for (int i = 0; i < pkgs.length; i++) {
            ...
            if (resPackage.getResSpecCount() > value && ! resPackage.getName().equalsIgnoreCase("apktool/android")) {
        ...
        // if id is still 0, we only have one pkgId which is "apktool.android" -> 1
    ...
    public void decodeManifestWithResources(ResTable resTable, ExtFile apkFile, File outDir)
        ...
        try {
            ...
            if (!resTable.getAnalysisMode()) {
                ...
                // also remove the apktool.android::versionCode / versionName from manifest for rebuild
    ...
    private final static String[] IGNORED_PACKAGES = new String[] {
        "apktool/android", "com.htc", "com.lge", "com.lge.internal", "yi", "flyme", "air.com.adobe.appentry",
