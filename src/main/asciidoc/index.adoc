...
Questo servizio cancella una singola versione di un'applicazione presente sul server.
...
Questo servizio elimina tutte le versioni presenti sul server di una specifica applicazione.
Risponde al metodo *HTTP DELETE* all'indirizzo
...
Questo servizio permette di eliminare una lista di versioni, corrispondenti agli id ricercati e passati come parametri.
Risponde al metodo *HTTP DELETE* all'indirizzo
